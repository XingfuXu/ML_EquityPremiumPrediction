# -*- coding: utf-8 -*-
# creat_time: 2021/11/25 22:45

## Robustness check: using a 10-year (20-year) rolling window schemes
...
# rolling window length, 10 years
# window_length = 10 * 12
# or
window_length = 20 * 12
...
for t in tqdm(range(in_out_1957, N)):
    #
    X_train_all = predictor[(t - window_length):t, 1:n_cols]
    y_train_all = predictor[(t - window_length):t, 0]
    #
...
results_OOS_sample_forecast1.insert(0, "Forecasting models",  ["HA", "OLS", "PLS", "PCR", "LASSO",
                                                               "ENet", "GBRT", "RF", "NN3"])
# results_OOS_sample_forecast1.to_csv("results_OOS_sample_forecast1_10_year_rolling.csv", index=False) # or 20_years_rolling.csv
results_OOS_sample_forecast1.to_csv("results_OOS_sample_forecast1_20_year_rolling.csv", index=False)
...
# results_OOS_sample_forecast2.to_csv("results_OOS_sample_forecast2_10_year_rolling.csv", index=False)  # or 20_years_rolling.csv
results_OOS_sample_forecast2.to_csv("results_OOS_sample_forecast2_20_year_rolling.csv", index=False)
